    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card" style="width: 100%;">
                <form action="index.php?act=add_sanpham" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="product_image">Chọn tải file ở
                                        đây...</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea
                                    ...
                                    class="form-control" id="product_describe" name="product_describe" required></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select class="select2 form-control custom-select" id="brand_id" name="brand_id" style="width: 100%; height:36px;"
                                    required>
                    ...
                    <div class="border-top" style="text-align: center;">
                        <div class="card-body">
                            <input type="submit" value="Thêm sản phẩm" class="btn btn-success" id="btn_addpro" name="btn_addpro">
                        </div>
                    </div>
                </form>
            </div>
