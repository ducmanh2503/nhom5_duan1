              ...
              ?>
                <div class="col-lg-4 bg-body-tertiary">
                  <div class="p-5">
                    ...
                    <a href="index.php?act=thanhtoan"><button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-block btn-lg" data-mdb-ripple-color="dark">Xác Nhận</button></a>
