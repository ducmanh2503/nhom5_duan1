        ...
        <div class="container">
            <div class="footer_logo_main">
                <div class="footer_logo"><a href="index.html">
                        <h1 class="footer-logo" style="font-size: 60px; font-weight: 700; color: #fff;">MVT</h1>
                    </a></div>
            ...
            <div class="footer_section_2">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <h4 class="adderss_text">About Us</h4>
                        <p class="ipsum_text">Shop bán máy tính & phụ kiện MVT, đảm bảo uy tín, chất lượng, giá rẻ nhất thị trường. Mua ngay nào!</p>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="footer_menu">
                            <ul>
                                ...
                                <li><a href="computers.html">Máy tính</a></li>
                                <li><a href="Mans_clothes.html">Màn hình</a></li>
                                <li><a href="womans_clothes.html">Bàn phím</a></li>
